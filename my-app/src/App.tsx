  ...
  <div >
      <div className="w-full max-w-6xl mx-auto bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl shadow-2xl p-10 border">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <h1 className="text-3xl font-extrabold text-indigo-700 tracking-tight drop-shadow">Employee Management</h1>
          <button
            onClick={handleAdd}
        ...
        {showForm && (
          <div className="mb-8 animate-fade-in">
            <EmployeeForm employee={editing} onSuccess={handleSuccess} onCancel={handleCancel} />
          </div>
        )}
